...
// export function register({ mapper, templateTsLs, ts }: ApiLanguageServiceContext) {
...
//             .filter(fileName => templateTsLs.__internal__.host.fileExists?.(fileName));
//     }
...
//     }
//     function getProgram() {
//         const program = templateTsLs.__internal__.raw.getProgram();
